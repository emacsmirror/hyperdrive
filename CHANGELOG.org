...
- Switch from `hyper-gateway` to `hyper-gateway-ushin` fork!  Please
  follow the [installation
  instructions](https://git.sr.ht/~ushin/hyper-gateway-ushin#installation).
- Much faster loading of directory listing
...
- Refactor to accommodate [[https://ushin.org/hyperdrive/hyperdrive-manual.html#hyperdrive-org-transclusion][hyperdrive-org-transclusion]]
