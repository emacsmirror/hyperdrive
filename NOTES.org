...
|------------------------------+-------------------------+-------------------|
| nothing                      | hyperdrive-write-buffer |                   |
| nothing                      | hyperdrive-save-buffer  |                   |
| file on disk                 | hyperdrive-write-buffer |                   |
| file on disk                 | hyperdrive-save-buffer  |                   |
| file on writable hyperdrive  | hyperdrive-write-buffer |                   |
| file on writable hyperdrive  | hyperdrive-save-buffer  |                   |
| file on read-only hyperdrive | hyperdrive-write-buffer |                   |
| file on read-only hyperdrive | hyperdrive-save-buffer  |                   |
