...
- ~RET~ or double left click opens file or directory at point
...
- ~RET~ or double left click opens the file at the start of the range at point
...
[[https://www.sanityinc.com/][Steve Purcell]] and [[https://github.com/akirak][Akira Komamura]] for suggestion to improve our CI
build manifests.
