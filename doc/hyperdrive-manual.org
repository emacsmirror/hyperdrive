...
** TODO Upload files from your filesystem

(Uploading files from the filesystem has not been reimplemented since
the upgrade to the latest version of hyper-gateway.)
...
[[https://protesilaos.com/emacs/denote][Denote]] file-naming scheme.
...
[[https://github.com/novoid/filetags/][filetags]]. Either way allows for
