...
If you enabled ~hyperdrive-menu-bar-mode~ (either in your [[*Example configuration][configuration]]
...
don't see the menu bar, please double check that ~menu-bar-mode~ is
