...
# modifications.
#+macro: version (eval (with-current-buffer (find-file-noselect "../hyperdrive.el") (org-with-point-at 1 (if (re-search-forward "Version: +\\([^\s\n]+\\)" nil t) (match-string-no-properties 1) (error "Missing \"Version\" keyword in \"org.el\"")))))
