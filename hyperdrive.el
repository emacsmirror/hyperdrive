...
;; Created: 2022
;; Version: 0.4-pre
;; Package-Requires: ((emacs "28.1") (map "3.0") (compat "29.1.4.4") (org "9.7.6") (plz "0.9.0") (persist "0.6.1") (taxy-magit-section "0.13") (transient "0.7.2"))
...
(defvar h/gateway-urls-and-hashes
  ...
  '((gnu/linux
    ...
    (windows-nt
     ...
     ;; ( :url "https://git.sr.ht/~ushin/hyper-gateway-ushin/refs/download/v3.10.2/hyper-gateway-windows-v3.10.2.exe"
     ;;   :sha256 "")
     ))
