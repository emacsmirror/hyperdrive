...
(defvar h/gateway-version-expected
  '(:name "hyper-gateway-ushin" :version "3.13.0"))
...
(declare-function he/equal-p "hyperdrive-lib")
(define-hash-table-test 'hyperdrive-existent-versions-key-test
                        #'he/equal-p #'sxhash-equal)

(persist-defvar h/existent-versions
  (make-hash-table :test 'hyperdrive-existent-versions-key-test)
